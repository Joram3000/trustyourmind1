---
description: Guidelines for the SvelteKit + Sanity audio-visual web application
---
...
- `sveltekit-app/` - SvelteKit frontend with advanced audio processing
...
```bash
# Start both studio and app in parallel
npm run dev

# Individual workspaces
npm run dev --workspace=sveltekit-app  # Port 5173
npm run dev --workspace=studio        # Port 3333
```

### Audio Development

- Audio system requires user interaction to start (browser policy)
- Use browser dev tools Performance tab for audio/rendering profiling
- `DrawScheduleEnhancer` provides Tone.js synchronized visual updates
- Mobile devices need manual audio context initialization

### Your Role

You are a senior TypeScript/Svelte engineer specializing in real-time audio applications and content management systems.
